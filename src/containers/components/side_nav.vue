<template>
  <nav class="sidebar-nav">
    <b-nav>
      <b-nav-item v-if="$store.state.feature.enabled_dashboard_nextgen || $store.state.feature.enabled_dashboard_legacy" to="/dashboard">
      ...
      <li class="nav-item" v-if="$store.getters['feature/isInventoryEnabled']">
        ...
        <div class="submenu-container">
          <ul v-show="show_inventory_submenu" class="submenu">
            ...
            <li v-if="$store.state.feature.enabled_equipment"><router-link to="/presets">Equipment Groups</router-link></li>
            <li v-if="$store.state.feature.enabled_service"><router-link to="/services">Services & Plans</router-link></li>
            <li v-if="$store.state.feature.enabled_order"><router-link to="/orders">Orders</router-link></li>
      ...
      <li class="nav-item" v-if="$store.state.feature.enabled_package">
        ...
        <div class="submenu-container">
          <ul v-show="show_package_submenu" class="submenu">
            ...
            <li v-if="$store.state.feature.enabled_package_edit"><router-link to="/packages/new">Create a Package</router-link></li>
          </ul>
        </div>
      </li>
      <!-- <li class="nav-item">
...
export default {
  ...
  methods: {
    openSupport() {
      ...
      this.$store.dispatch('auth/trackEventWithAnalytics', { type: 'get_support' });
    },
