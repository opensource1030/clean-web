                                ...
                                <div class="row">
                                    <div class="large-12 small-12 columns">
                                        <div class="input-group bg-orange">
                                            ...
                                            <input id="email" class="input-group-field" type="text"
                                                   v-model="credentials.email" :placeholder="companyEmail"/>
                  </div>
                </div>
                                </div>
                                <div class="large-12 small-12 columns"
                                     style="text-align:center; color:black; padding-bottom: 20px;">
                                    {{message}}
                                </div>
                                <div v-show="$store.getters['error/hasError']" class="large-12 small-12 columns"
                                     style="text-align:center; color:red; padding-bottom: 20px;">
                                    {{$store.getters['error/error']}}
                                </div>
                                <div v-show="variations.messageShow" class="large-12 small-12 columns"
                                     style="text-align:center; color:green; padding-bottom: 20px;">
                                    {{allOk}}
                                </div>
                                <div class="row">
