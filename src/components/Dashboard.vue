      ...
      <form id="support-form">
        <div class="row support-form-container">
          <div class="medium-12 columns">
            <label><span class="form-title"> How Can We Help?</span> <span data-tooltip aria-haspopup="true"
          ...
          <div id="Container">
            ...
            <div class="medium-12 columns mix amd">
              <label><span class="form-title">Device type, Make/Model </span> <span data-tooltip aria-haspopup="true"
                                                                                    ...
                                                                                    tabindex="1" title="Required Field">*</span>
            ...
            <div class="medium-12 columns mix amd">
              <label><span class="form-title">Phone Origin </span><span data-tooltip aria-haspopup="true"
                                                                        class="has-tip top is-required"
                                                                        data-disable-hover="false" tabindex="1"
                                                                        title="Where did you get the phone? IE: New Service, Upgrade, Internal">*</span>
            ...
            <div class="medium-12 columns mix ec">
              <fieldset class="fieldset">
                <legend><span class="form-title">Email Services </span> <span data-tooltip aria-haspopup="true"
                                                                              class="has-tip top is-required"
                                                                              data-disable-hover="false" tabindex="1"
                                                                              title="Required Field">*</span></legend>

                <input type="radio" name="email_services" value="Email Setup" id="email_setup" required><label
                for="email_setup">Email Setup</label>
                <input type="radio" name="email_services" value="Email Troubleshooting"
                       id="email_troubleshooting"><label for="email_troubleshooting">Email Troubleshooting</label>
              </fieldset>
            </div>

            <div class="medium-12 columns ">
              <div><span class="form-title">Requestor Email (whomever is filling out this form)</span> <span
                data-tooltip aria-haspopup="true" class="has-tip top is-required" data-disable-hover="false"
                tabindex="1" title="Required Field">*</span> <span data-tooltip aria-haspopup="true" class="has-tip top"
                                                                   data-disable-hover="false" tabindex="1"
            ...
            <div class="medium-12 columns ">
              <label><span class="form-title">Recipient Email (the affected user)</span> <span data-tooltip
                                                                                               ...
                                                                                               tabindex="1"
                                                                                               title="Required Field">*</span>
                <span data-tooltip aria-haspopup="true" class="has-tip top" data-disable-hover="false" tabindex="1"
                      title="The affected user."><i class="fa fa-question-circle"> </i> </span>
                <input type="text" id="recipient_email" placeholder="your email">
              </label>
            </div>
            <div class="medium-12 columns">
              <label><span class="form-title">Recipient Mobile Number (if number is unavailable, please add N/A)</span>
                <span data-tooltip aria-haspopup="true" class="has-tip top is-required" data-disable-hover="false"
                      tabindex="1" title="Required Field">*</span> <span data-tooltip aria-haspopup="true"
                                                                         class="has-tip top" data-disable-hover="false"
                                                                         tabindex="1"
                                                                         title="if number is unavailable, please add N/A."><i
                  class="fa fa-question-circle"> </i> </span>
            ...
            <div class="large-12 columns ">
              <fieldset class="fieldset">
                <legend><span class="form-title">Priority </span> <span data-tooltip aria-haspopup="true"
                                                                        class="has-tip top is-required"
                                                                        data-disable-hover="false" tabindex="1"
                                                                        title="Required Field">*</span></legend>
                <div class="row">
                  <div class="column large-6">
                    <input type="radio" name="priority" value="Low" id="low" required><label for="low">Low</label>
                  </div>
                  <div class="column large-6">
                    <input type="radio" name="priority" value="Medium" id="medium"><label for="medium">Medium</label>
                  </div>
                  <div class="column large-6">
                    <input type="radio" name="priority" value="High" id="high"><label for="high">High</label>
                  </div>
                  <div class="column large-6">
                    <input type="radio" name="priority" value="Asap" id="asap"><label for="asap">Asap</label>
                  </div>
                </div>
            ...
            <div class="large-12 columns ">
              <fieldset class="fieldset">
                <legend><span class="form-title">Who should we contact? </span> <span data-tooltip aria-haspopup="true"
                                                                                      class="has-tip top is-required"
                                                                                      data-disable-hover="false"
                                                                                      tabindex="1"
                                                                                      title="Required Field">*</span>
                ...
                <div class="row">
                  <div class="column large-6">
                    <input type="radio" name="contact-person" value="Recipent" id="recipent" required><label
                    for="recipent">Recipent</label>
                  </div>
                  <div class="column large-6">
            ...
            <div class="medium-12 columns">
              <label><span class="form-title">Description</span> <span data-tooltip aria-haspopup="true"
                                                                       class="has-tip top is-required"
                                                                       data-disable-hover="false" tabindex="1"
                                                                       title="Required Field">*</span> <span
                data-tooltip aria-haspopup="true" class="has-tip top" data-disable-hover="false" tabindex="1"
                title="Please explain the question or problem in detail, and let us know how you'd like to be contacted."><i
                class="fa fa-question-circle"> </i> </span>
