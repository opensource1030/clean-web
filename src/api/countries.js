...
function populateCountries(countryElementId, stateElementId) {
    ...
    countryElement.options[0].setAttribute("disabled", "disabled");
...
export default { populateStates , populateCountries }
