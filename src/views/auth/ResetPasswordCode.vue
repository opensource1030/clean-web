              ...
              <b-card-body>
                <b-form v-on:submit.prevent="submit()">
                 ...
                 <b-input-group class="mb-3">
                  ...
                  <b-input-group class="mb-3">
                    <b-input-group-prepend><b-input-group-text><i class="icon-key"></i></b-input-group-text></b-input-group-prepend>
                    <b-form-input type="text" v-model="credentials.password2" v-show="passwordType" id="password2" class="form-control" :placeholder="repeatPassword" autocomplete="Repeat your password" />
                    <b-form-input type="password" v-model="credentials.password2" v-show="!passwordType" id="password2" class="form-control" :placeholder="repeatPassword" autocomplete="Repeat your password" />
                  </b-input-group>
                  <b-row class="mb-3">
                    <b-col cols="6">
                        <b-form-checkbox
