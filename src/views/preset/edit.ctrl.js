  ...
  created () {
    ...
    if (this.$route.params.id != null) {
      ...
      presetAPI.getOne(this.$route.params.id, _params, (res) => {
        ...
        // console.log('preset/edit created', this.preset)
  ...
  methods: {
    ...
    asyncFind_CompanyNames (query) {
      ...
      companyAPI.search(_params, (res) => {
        ...
        // console.log('preset/edit asyncFind_CompanyNames', this.filters.companies.options)
      }, (err) => {
      })
    },

    addFilter_CompanyNames (value) {
      // console.log('addFilter_CompanyNames', value, this.preset.companies[0])
