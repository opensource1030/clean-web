              ...
              <div class="box-content-holder">
                <div class="row expanded">
                  <div class="large-6 medium-12 columns">
                    <label><strong>{{names.title}}</strong>
                ...
                <div class="row">
                  <div class="columns medium-6">
                    <label><strong>{{names.description}}</strong>
                  ...
                  <div class="medium-6 columns">
                    <label><strong>{{names.carriers}}</strong>
                      <div class="multiselect-holder">
                        <multiselect
                    ...
                    <label>
                      ...
                      <div class="switch tiny">
                        <input class="switch-input" :id="'status-' + serviceDetails.id" type="checkbox"
                               :name="'status-' + serviceDetails.id"
                               @input="$store.commit('service/updateServiceDetail',{e:$event,type:'status'})">
                    ...
                    <div class="row expanded ">
                      ...
                      <div class="large-4 medium-12 columns">
                        <div class="form-label">
                          <label for="domestic-plan"><strong><i class="fa fa-database " aria-hidden="true"></i>
                            {{names.data}} </strong></label>
                          <div class="row collapse">
                            <div class="small-8 columns">
                              <div class="input-group">
                                <span class="input-group-label"> {{names.amount}} </span>
                                <input id="domestic-plan" class="input-group-field" :title="names.ammountMessage"
                                       name="dataD" type="number" min="0" placeholder=""
              ...
              <div class="box-content-holder">
                <div class="row row-wrapper expanded addlist " v-for="(addon,index) in addons">
                  ...
                  <div class="btn-control">
                    <a class="button delete" @click="$store.commit('service/deleteAddOns',index)" id="button"
                       :id="'delete'+index"><i class="fa fa-close"></i></a>
                  </div>
