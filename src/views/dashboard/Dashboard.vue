        ...
        <div class="grid-box">
          <div class="box-content-holder place-order">
            <div class="row expanded p-20">
              <div class="columns small-12 medium-4 each-order" @click="selectOrderType('newService')">
              ...
              <div class="columns small-12 medium-4 each-order" @click="selectOrderType('transferService')">
              ...
              <div class="columns small-12 medium-4 each-order" @click="selectOrderType('orderAccessory')">
          ...
          <div class="columns small-12">
            <div class="grid-box">
              ...
              <div class="box-content-holder no-padding" v-else>
                <PieChart :data="userInfo.data.allocations"></PieChart>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row expanded">
          ...
          <div class="columns small-12">
            <div class="grid-box">
              ...
              <div class="box-content-holder no-padding" v-else>
                <TrendChart :data="userInfo.data.allocations"></TrendChart>
              </div>
            </div>
          </div>
        </div>
