        ...
        <table>
            ...
            <template v-for="(device, index) in devices">
                <tr @click="setActive(device)" id="open">
                    ...
                    <td>
                        <div v-for="carrier in device.priceName">{{carrier.carrier}}</div>
                    </td>
                    <td>
                        <div v-for="capacity in filterByModificationsd(device.modifications, 'capacity')">{{
                            capacity.value }}
                        </div>
                    </td>
                    <td>
                        <div v-for="style in filterByModificationsd(device.modifications, 'style')">{{ style.value }}
                        </div>
                    </td>
                </tr>
                <tr>
                    <td v-show="activeDevice && (activeDevice.id == device.id)" transition="device"
                        @click="setActive(device)" class="detail" colspan="7">
