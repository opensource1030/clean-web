                                ...
                                <div class="small-12 large-10 columns">
                                    <div class="row">
                                        <div class="large-3 small-12 columns">
                                            <label>Default Price
                                                <inputValidate id="testDefaultPrice" class="capacitys"
                                                               :value="d.defaultPrice"
                                                               v-model="d.defaultPrice"></inputValidate>
                                            </label>
                                        </div>
                                        ...
                                        <div class="small-12 large-6 columns">
                                            <label>Device Type
                                                <select id="testDeviceType" v-model="d.type">
                                                    ...
                                                    <option v-for="devicet in deviceType.data" :value="devicet.id">
                                                        {{devicet.attributes.name}}
                                                    </option>
                                                </select>
                                            </label>
                                        </div>
                                        ...
                                        <div class="small-12 large-6 columns">
                                            <label>Manufactured
                                                <input id="testManu" type="text" placeholder="" :value="d.make"
                                                       v-model="d.make">
                                            </label>
                                        </div>
                                        <div class="small-12 large-6 columns">
                                            <label>Model
                                                <input type="text" id="testModel" placeholder="" :value="d.model"
                                                       v-model="d.model">
                                            </label>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="small-12 large-12 columns">
                                            <label>Tecnical Information
                                                <textarea rows="6" id="testInfo" :value="d.description"
                                                          v-model="d.description"></textarea>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="small-6 columns">
                                        <label style=" font-weight: bold;">Capacity
                                            <inputValidate class="capacitys" placeholder="Custom"
                                                           v-model="gigas"></inputValidate>
                                        </label>
                                    </div>
                    ...
                    <div class="accordion-content carriers" data-tab-content>
                        <div class="imagescheck">
                            <div class="crop" v-for="(carrier,index) in carriers.data">
                                <label class="static">
                                    <input type="checkbox" :id="'cr'+carrier.id"
                                           @click="changeStatusCarrier('active',index)" v-model="carrier.check">
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="acordeon-item prices" data-accordion-item>
                    ...
                    <div class="hide-for-small-only hide-for-medium-only  filterprices" v-show="show">
                        <select class="form-control" v-model="filter.capacity">
                            ...
                            <option v-for="capacity in vCapacity" :value="capacity">{{capacity.attributes.value}}
                            </option>
                        </select>
                        ...
                        <select class="form-control" v-model="filter.carrier">
                            ...
                            <option value="" v-for="carrier in vCarriers" :value="carrier">{{carrier.presentation}}
                            </option>
                        </select>
                    ...
                    <div class="accordion-content" data-tab-content>
                        <div class="column row" v-for="(p,index) in findByPrices(priceTable,filter)"
                             :style="{ backgroundColor: color }">
                            <div class="row">
                                <div class="small-12 large-2 columns">
                                    <img class="phoneImg" :src="p.imageVariations.url" alt="Photo Devices"/>
                                    <input type="file" :id="'FileUpload'+index" @change="onFileChanges($event,index)"
                                           class="show-for-sr">
                                </div>
                                <div class="small-12 large-10 columns">
                                    <div class="row">
                                        <div class="large-3 small-12 columns">
                                            <label>Retail Price
                                                <div class="input-group">
                                                    ...
                                                    <inputValidate class="input-group-field"
                                                                   v-model="p.priceRetail"></inputValidate>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="large-3 small-12 columns">
                                            <label>Price One
                                                <div class="input-group">
                                                    <span class="input-group-label">{{money}}</span>
                                                    <inputValidate class="input-group-field"
                                                                   v-model="p.price1"></inputValidate>
                                                </div>
                                            </label>
                  </div>
                                        <div class="large-3 small-12 columns">
                                            <label>Price Two
                                                <div class="input-group">
                                                    <span class="input-group-label">{{money}}</span>
                                                    <inputValidate class="input-group-field"
                                                                   v-model="p.price2"></inputValidate>
                                                </div>
                                            </label>
                  </div>
                                        <div class="large-3 small-12 columns">
                                            <label>Price Own
                                                <div class="input-group">
                                                    <span class="input-group-label">{{money}}</span>
                                                    <inputValidate class="input-group-field"
                                                                   v-model="p.priceOwn"></inputValidate>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="large-3 small-12 columns">
                                            <div class="features">
                                                <select v-model="p.capacity">
                                                    ...
                                                    <option v-for="c in p.capacitys" :value="c.id">
                                                        {{c.attributes.value}}
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="large-3 small-12 columns">
                                            <div class="features">
                                                <select v-model="p.style">
                                                    ...
                                                    <option v-for="s in p.styles" :value="s.id">{{s.attributes.value}}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="large-3 small-12 columns">
                                            <div class="features">
                                                <select v-model="p.carrierId">
                                                    ...
                                                    <option v-for="c in p.carriers" :value="c.id">{{c.presentation}}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="large-3 small-12 columns">
                                            <div class="features">
                                                <select v-model="p.companyId">
                                                    ...
                                                    <option v-for="co in p.companys" :value="co.id">
                                                        {{co.attributes.name}}
                                                    </option>
                                                </select>
                                            </div>
                      ...
                      <label :for="'FileUpload'+index" :id="'f'+index" class="button large">Upload File</label>
                                        ...
                                        <div clas="large-3 small-12 columns">
                                            <label>
                                                ...
                                                <a class="button" @click="adds()" id="button"><i
