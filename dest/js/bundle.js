...
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _app=require('../app');var _vue=require('vue');var _vue2=_interopRequireDefault(_vue);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}// Check the user's auth status when the app
...
setTimeout(function(){_this.logout();},response.data.expires_in*1000);_app.router.go('../'+redirect);},function(response){});},register:function register(context,creds,redirect){},loginLocal:function loginLocal(context,creds,redirect){var _this2=this;if(creds.password==""||creds.password==null){context.error="Password incorrect";}else{context.$http.post(api+'/oauth/access_token',{grant_type:'password',client_id:'g73hhd8j3bhcuhdbbs88e4wd',client_secret:'786wndkd8iu4nn49ixjndfodsde33',username:creds.email,password:creds.password}).then(function(response){console.log(response.data);_this2.user.authenticated=true;localStorage.setItem('token',response.data.access_token);setTimeout(function(){_this2.logout();},response.data.expires_in*1000);_app.router.go('../'+redirect);},function(response){console.log(response.data.message);context.error=response.data.message;});}},logout:function logout(){localStorage.removeItem('token');this.user.authenticated=false;_app.router.go('/');},checkAuth:function checkAuth(){var jwt=localStorage.getItem('token');if(jwt){this.user.authenticated=true;}else{this.user.authenticated=false;}},// The object to be passed as a header for authenticated requests
getAuthHeader:function getAuthHeader(){return{'Authorization':'Bearer '+localStorage.getItem('token')};}};

},{"../app":31,"vue":29}],31:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.router=undefined;var _vue=require('vue');var _vue2=_interopRequireDefault(_vue);var _vueResource=require('vue-resource');var _vueResource2=_interopRequireDefault(_vueResource);var _vueRouter=require('vue-router');var _vueRouter2=_interopRequireDefault(_vueRouter);var _jquery=require('jquery');var _jquery2=_interopRequireDefault(_jquery);var _App=require('./components/App.vue');var _App2=_interopRequireDefault(_App);var _Sso=require('./components/Sso.vue');var _Sso2=_interopRequireDefault(_Sso);var _Login=require('./components/Login.vue');var _Login2=_interopRequireDefault(_Login);var _Register=require('./components/Register.vue');var _Register2=_interopRequireDefault(_Register);var _LoginLocal=require('./components/LoginLocal.vue');var _LoginLocal2=_interopRequireDefault(_LoginLocal);var _Dashboard=require('./components/Dashboard.vue');var _Dashboard2=_interopRequireDefault(_Dashboard);var _auth=require('./api/auth.js');var _auth2=_interopRequireDefault(_auth);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}// Install plugins
_vue2.default.use(_vueRouter2.default);_vue2.default.use(_vueResource2.default);// Set up a new router
var router=exports.router=new _vueRouter2.default();_auth2.default.checkAuth();// Route config
router.map({'/login':{name:'login',component:_Login2.default},'/register':{name:'register',component:_Register2.default},'/loginLocal':{name:'loginLocal',component:_LoginLocal2.default},'/dashboard':{name:'dashboard',component:_Dashboard2.default,auth:true},'/sso/:id':{name:'sso',component:_Sso2.default}});// For every new route scroll to the top of the page
router.beforeEach(function(){window.scrollTo(0,0);});router.beforeEach(function(transition){if(transition.to.auth&&!_auth2.default.user.authenticated){transition.redirect('/login');}else{transition.next();}});// If no route is matched redirect home
router.redirect({'*':'/login'});// Start up our app
router.start(_App2.default,'#app');

},{"./api/auth.js":30,"./components/App.vue":32,"./components/Dashboard.vue":33,"./components/Login.vue":34,"./components/LoginLocal.vue":35,"./components/Register.vue":37,"./components/Sso.vue":38,"jquery":1,"vue":29,"vue-resource":17,"vue-router":28}],32:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _Navbar=require("./Navbar.vue");var _Navbar2=_interopRequireDefault(_Navbar);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={name:"App",components:{Navbar:_Navbar2.default}};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2954dc4f", module.exports)
  } else {
    hotAPI.update("_v-2954dc4f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./Navbar.vue":36,"vue":29,"vue-hot-reload-api":3}],33:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.default={name:"Dashboard"};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-67a5f2c2", module.exports)
  } else {
    hotAPI.update("_v-67a5f2c2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":29,"vue-hot-reload-api":3}],34:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _auth=require('./../api/auth');var _auth2=_interopRequireDefault(_auth);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={data:function data(){return{// We need to initialize the component with any
...
_auth2.default.login(this,credentials,'dashboard');}}};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-b2b87fd2", module.exports)
  } else {
    hotAPI.update("_v-b2b87fd2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../api/auth":30,"vue":29,"vue-hot-reload-api":3}],35:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _auth=require('./../api/auth');var _auth2=_interopRequireDefault(_auth);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={name:"loginLocal",data:function data(){return{// We need to initialize the component with any
// properties that will be used in it
...
// to properly make use of http in the auth service
_auth2.default.loginLocal(this,credentials,'dashboard');}}};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-be54e378", module.exports)
  } else {
    hotAPI.update("_v-be54e378", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../api/auth":30,"vue":29,"vue-hot-reload-api":3}],36:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e804c25c", module.exports)
  } else {
    hotAPI.update("_v-e804c25c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../api/auth":30,"vue":29,"vue-hot-reload-api":3}],37:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _auth=require('./../api/auth');var _auth2=_interopRequireDefault(_auth);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={name:"register",data:function data(){return{// We need to initialize the component with any
// properties that will be used in it
credentials:{firstName:'',lastName:'',email:_auth2.default.user.email},error:''};},methods:{submit:function submit(){var credentials={firstName:this.credentials.firstName,password:this.credentials.lastName,email:this.credentials.email};// We need to pass the component's this context
// to properly make use of http in the auth service
_auth2.default.register(this,credentials,'dashboard');}}};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6fc06536", module.exports)
  } else {
    hotAPI.update("_v-6fc06536", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../api/auth":30,"vue":29,"vue-hot-reload-api":3}],38:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _auth=require('./../api/auth');var _auth2=_interopRequireDefault(_auth);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={name:"Sso",ready:function ready(){var id=this.$route.params.id;_auth2.default.singleSignOn(this,id,'dashboard');}};
if (module.exports.__esModule) module.exports = module.exports.default
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-32d50d86", module.exports)
  } else {
    hotAPI.update("_v-32d50d86", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./../api/auth":30,"vue":29,"vue-hot-reload-api":3}]},{},[31]);
