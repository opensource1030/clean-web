...
/***/ function(module, exports, __webpack_require__) {
	...
	router.beforeEach(function(){window.scrollTo(0,0);});router.beforeEach(function(transition){if(transition.to.auth&&!_auth2.default.user.authenticated){transition.redirect('/login');}transition.next();});// If no route is matched redirect home
